...
//    private final RegistrationService registrationService;
    ...
    public RegistrationController(@Qualifier("registrationRequest")
                                          MessageChannel registrationRequestChannel)
    {
    ...
    public String submit(@ModelAttribute("registration") @Valid AttendeeRegistration registration, BindingResult bindingResult)
    {
        ...
        Message<AttendeeRegistration> msg =
                MessageBuilder
                        .withPayload(registration)
                        .setHeader("dateTime", OffsetDateTime.now())
                        .build();
        registrationRequestChannel.send(msg);
